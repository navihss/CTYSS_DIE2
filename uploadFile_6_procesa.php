...
if(isset($_FILES["file"]["type"]))
{
    ...
    if ($_FILES["file"]["type"] == "application/pdf" && 
        ...
        if ($_FILES["file"]["error"] > 0){
            ...
            if ($_POST['id_documento_insc'] == 5){
              $archivo = 'Docs/Baja_de_Propuesta/' . 
                        $_POST['id_usuario_insc'] . '_' .
                        $_POST['id_carrera_doc'] . '_' .                      
                        $_POST['id_propuesta_doc'] . '_' .
                        $_POST['id_version_insc'] . '_'.
                        $_POST['desc_corta_doc'] . '.pdf';               
            }
            else{
              $archivo = 'Docs/Inscripcion_A_Propuesta/' . 
                        $_POST['id_usuario_insc'] . '_' .
                        $_POST['id_carrera_doc'] . '_' .                      
                        $_POST['id_propuesta_doc'] . '_' .
                        $_POST['id_version_insc'] . '_'.
              ...
              {
                    //Actualizamos el estatus del documento a 10. Por Autorizar por Prof.
                    $obj_ = new d_alumno_Mi_Titulacion_Por_Propuesta();
                    $array = json_decode($obj_->Actualizar_Estatus_Doc_Enviado($_POST['id_inscripcion'], 
                            $_POST['id_documento_insc'], $_POST['id_version_insc'], 10));
                    ...
                    $obj_miBitacora->set_Id_Usuario_Genera($_POST['id_usuario_insc']);
