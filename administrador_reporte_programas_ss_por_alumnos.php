            ...
            $( document ).ready(function() {
              ...
              //LLENAMOS LOS CATALOGOS
                ...
                function Obtener_Catalogo_Tipo_Servicio(id_carrera){
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_CATALOGO_TIPO_SERVICIO_SOCIAL', 
                    				id_carrera  : id_carrera
                            };
            ...
            <div >
                <div >
                	<form action="" method="post" target="_blank" id="FormularioExportacion">
                        ...
                        <a href="javascript:enviar_formulario('word','Profesores',3,'Programas Servicio Social por Alumnos')" ><img src="css/images/office_word.png"/></a> |
                        <a href="javascript:enviar_formulario('excel','Profesores',3,'Programas Servicio Social por Alumnos')"><img src="css/images/office_excel.png"/></a> |
                        <a href="javascript:enviar_formulario('pdf','Profesores',3,'Programas Servicio Social por Alumnos')"><img src="css/images/Oficina_PDF.png"/></a>
