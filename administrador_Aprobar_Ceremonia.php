...
Objetivo:       Interfaz para Aprobar los documentos para Ceremonia
-->
...
<!--        <title>TODO supply a title</title>
        ...
        <script>
            $( document ).ready(function() {
                ...
                function Obtener_Ceremonias(){                                           
                    //Obtenemos las ceremonias por Autorizar
                    var datos = {Tipo_Movimiento : 'OBTENER_CEREMONIAS_PENDIENTES'
                                };
                    $.ajax({
                       data : datos,
                       type : "POST",
                       dataType : "json",
                       url : "_Negocio/n_administrador_Aprobar_Ceremonia.php"
                    })
                ...
                $('#tabla_Ceremonias').on("click", "button.btn_MostrarDocs", function(e){
                    ...
                    $('#ventanaMostrarPDF').dialog({
                        ...
                        buttons:[{
                            id:"btn_Aceptar_Doc", text:"Aceptar Doc", click: function() {
                                 $('#nota_admin_a').val('');
                                 $('#ventanaConfirmaAceptacion').dialog('open');
                                }},{
                           id:"btn_Rechazar_Doc", text:"Rechazar Doc", click: function() {                            
                                 $('#nota_admin').val('');
                                 $('#ventanaConfirmaRechazo').dialog('open');
                                }},{
                           id:"btn_Cerrar", text:"Cerrar", click: function() {                            
                                 $(this).dialog('close');
                                 Obtener_Ceremonias();
                        }}],                                                                       
                        open : function(){
                            ...
                            Obtener_Documentos_Pendientes(id_ceremonia, 2); //2. Por Autorizar Admin.
                ...
                function Obtener_Documentos_Pendientes(id_ceremonia, id_estatus){                                         
                    var datos = {Tipo_Movimiento : 'OBTENER_DOCUMENTOS_PENDIENTES',
...
//                                                    $(this).dialog('close');
                ...
                function actualiza_Estatus_Documento(id_estatus, nota, todos_revisados)
                {
                    $('#ventanaProcesando').dialog('open');
                    $.ajax({
                        data : {Tipo_Movimiento : 'ACTUALIZAR_ESTATUS_DOC',
