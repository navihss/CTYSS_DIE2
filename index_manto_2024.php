...
<body>
    ...
    <div id="contenido">
        <center>Toma en cuenta que a partir del 22 de marzo de 2023 y hasta las 09:00 horas del 1 de abril de 2024 inicia un periodo de vacaciones administrativas para nuestra Facultad por lo que se suspenderá la atención presencial y/o vía sistema/correo electrónico de los
            servicios brindados por la Coordinación de Titulación y Servicio Social.<br>
            <br>División de Ingeniería Eléctrica. <br>
            <!--           
		   <div id="titModulo">
