...
//                        exit();
  ...
  function Actualizar_Estatus_Doc_($id_ceremonia, $id_documento, $version, $desc_documento,
          $nota, $id_estatus, $id_coordinador, $mail_coordinador, $todos_revisados, 
          $desc_corta_nom_archivo, $rechazados, $fecha_alta_ceremonia, $datos_archivos, $id_division){
            ...
            if ($todos_revisados == 1){ //todos los documentos han sido revisados
                ...
                if($rechazados != ''){
                    ...
                    for($i=0; $i < $renglones; $i++ ){
                        ...
                        $params2 = array($id_ceremonia, $arr_doc_rechazado[0], 
                            $arr_doc_rechazado[1] + 1, 1);
                        /* Preparamos la sentencia a ejecutar */
