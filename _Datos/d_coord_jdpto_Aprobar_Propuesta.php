    ...
    function Actualizar_Aceptacion_Doc($id_propuesta_doc, $id_documento_doc, $id_version_doc, 
        ...
        try{                
            ...
            $params1 = array(
                        ...
                        $nota, $id_propuesta_doc,
                        $id_documento_doc, $id_version_doc, $id_usuario);
            /* Preparamos la sentencia a ejecutar */
            ...
            if($propuesta_Revisada){ 
                                ...
                                if($stmt6->rowCount() > 0){                    
                                    ...
                                    $tsql7=" INSERT INTO jurado_vobo(id_propuesta, version, num_profesor, id_usuario, id_estatus) 
                                             SELECT ?, ?, ?, id_usuario, ?
                                                ...
                                                ORDER BY id_usuario;";
                                    /* Valor de los parámetros. */
                                    $params7 = array($id_propuesta_doc, $id_version_doc, $i, 11,
                                            $id_propuesta_doc, $id_version_doc);
                                    /* Preparamos la sentencia a ejecutar */
                ...
                if ($nvo_Estatus ==4){ //4. Rechazado
                    ...
                    /* Valor de los parámetros. */
                    $params4 = array($id_propuesta_doc, $id_documento_doc, $id_version_doc + 1,
                        date('d-m-Y H:i:s'), '', 1); //1. Sin Enviar
                    /* Preparamos la sentencia a ejecutar */
