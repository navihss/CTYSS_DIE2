...
class d_administrador_admon_Programas_SS
{
    ...
    function Agregar($obj_programa, $id_administrador, $carreras, $id_division)
    {
        ...
        try {
            ...
            /* Valor de los parámetros. */
            $params2 = array(
                $obj_Programa->get_Id_Programa(),
                $obj_Programa->get_Descripcion(),
                $obj_Programa->get_Subdireccion(),
                $obj_Programa->get_Responsable(),
                $obj_Programa->get_Cargo(),
                $obj_Programa->get_Email(),
                $obj_Programa->get_Oficina(),
                $obj_Programa->get_Calle(),
                $obj_Programa->get_Colonia(),
                $obj_Programa->get_Delegacion(),
                $obj_Programa->get_CP(),
                $obj_Programa->get_Num_Exterior(),
                $obj_Programa->get_Num_Interior(),
                $obj_Programa->get_Telefono_SS(),
                $obj_Programa->get_Telefono_Dependencia(),
                $obj_Programa->get_Id_Dependencia(),
                $obj_Programa->get_Tipo_Programa(),
                $obj_Programa->get_Id_Estado(),
                $obj_Programa->get_Id_Estatus(),
                $id_division
            );
            /* Preparamos la sentencia a ejecutar */
