        ...
        try{    
            ...
            if($obj_bitacora->get_Id_Usuario_Destinatario() == ''){
                $tsql2=" INSERT INTO bitacora (
                        ...
                        VALUES (?, ?, ?, ?, ?, ?);";
                $params2 = array($obj_bitacora->get_Id_Usuario_Genera(), $obj_bitacora->get_Id_Tipo_Evento(),
                    $obj_bitacora->get_Id_Tema_Bitacora(), $obj_bitacora->get_Fecha_Evento(), 
                    $obj_bitacora->get_Descripcion_Evento(), $obj_bitacora->get_Id_Division());                
            }else {
                $tsql2=" INSERT INTO bitacora (
                        id_usuario_genera, id_tipo_evento,
                        id_tema_bitacora, fecha_evento,
                ...
                $params2 = array($obj_bitacora->get_Id_Usuario_Genera(), $obj_bitacora->get_Id_Tipo_Evento(),
                    $obj_bitacora->get_Id_Tema_Bitacora(), $obj_bitacora->get_Fecha_Evento(), 
                    $obj_bitacora->get_Id_Usuario_Destinatario() ,$obj_bitacora->get_Descripcion_Evento(), $obj_bitacora->get_Id_Division());                
            }    
