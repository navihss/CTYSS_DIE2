    ...
    <script>
        $(document).ready(function() {
            ...
            function Obtener_Reportes_Estadisticas(id_estatus) {
                var datos = {
                    Tipo_Movimiento: 'OBTENER_REPORTES_ESTADISTICAS',
        ...
        <div>
            <div>
                <form action="" method="post" target="_blank" id="FormularioExportacion">
                    <a href="javascript:enviar_formulario('word')"><img src="./assets/images/ui/office_word.png" /></a> |
                    <a href="javascript:enviar_formulario('excel')"><img src="./assets/images/ui/office_excel.png" /></a> |
                    <a href="javascript:enviar_formulario('pdf')"><img src="./assets/images/ui/Oficina_PDF.png" /></a>
