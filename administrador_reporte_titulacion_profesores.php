        ...
        <div>
            <div>
                <form action="" method="post" target="_blank" id="FormularioExportacion">
                    <a href="javascript:enviar_formulario('word','ReporteSS',2,'profesores')"><img src="./assets/images/ui/office_word.png" /></a> |
                    <a href="javascript:enviar_formulario('excel','ReporteSS',2,'profesores')"><img src="./assets/images/ui/office_excel.png" /></a> |
                    <a href="javascript:enviar_formulario('pdf','ReporteSS',2,'profesores')"><img src="./assets/images/ui/Oficina_PDF.png" /></a>
