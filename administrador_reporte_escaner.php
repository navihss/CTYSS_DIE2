        ...
        <script>
            $( document ).ready(function() {
                ...
                function Obtener_Reportes_Estadisticas(tx_profesor,tx_tipo_trabajo,fecha_inicio){
                    var datos = {Tipo_Movimiento : 'OBTENER_REPORTES_FORMATOS',
            ...
            <div >
                <div >
                	<form action="" method="post" target="_blank" id="FormularioExportacion">
                        ...
                        <a href="javascript:enviar_formulario('word','ReporteSS',5,'Formatos')" ><img src="css/images/office_word.png"/></a> |
                        <a href="javascript:enviar_formulario('excel','ReporteSS',5,'Formatos')"><img src="css/images/office_excel.png"/></a> |
                        <a href="javascript:enviar_formulario('pdf','ReporteSS',5,'Formatos')"><img src="css/images/Oficina_PDF.png"/></a>
