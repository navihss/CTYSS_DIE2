...
<body>
    ...
    <center>
        <button onclick="window.location.href='https://odin.fi-b.unam.mx/CTYSS_DIE/indexAlumno.php'">
            <h2><strong>Alumn@</strong></h2>
        </button>
        <button onclick="window.location.href='https://odin.fi-b.unam.mx/CTYSS_DIE/indexProfesor.php'">
            <h6><strong>Profesor@</strong></h6>
        </button>
    </center>
    <div id="pie">
