        ...
        <script>
            $( document ).ready(function() {
                ...
                function Obtener_Mis_Ceremonias(id_alumno, id_carrera){
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_MIS_CEREMONIAS',
                               id_alumno : id_alumno,
                ...
                $('#btn_Agregar_Ceremonia').on('click',function(event){
                    ...
                    var datos = {Tipo_Movimiento : 'SELECCIONAR_MODALIDAD',
                                            ...
                                            $('#ventanaConfirmacionBorrar').dialog({
                                                buttons:{
                                                     "Aceptar" : function() {                            
                                                            ...
                                                            $.ajax({
                                                                data : {Tipo_Movimiento : 'BORRAR_CEREMONIA',
...
//                           Obtenemos la infor de la Ceremonia
                           var datos = {Tipo_Movimiento : 'OBTENER_CEREMONIA',
                                        id_ceremonia : id_ceremonia};
                            $.ajax({
                                data : datos,
                                type : "POST",
                           ...
                           switch(id_tipo_propuesta){
                               case 7: $('#div_Articulo').show();
                                       $('#div_Revista').show();
                                   break;
                               case 8: $('#div_Sede').show();
                                       $('#div_Materias').show();
                                   break;
                               case 9: $('#div_Sede').show();
                                       $('#div_Diplomado').show();
                                   break;
                               case 10: $('#div_Sede').show();
                                        $('#div_Progama').show();
                                   break;
                               case 11:
                               case 12:
