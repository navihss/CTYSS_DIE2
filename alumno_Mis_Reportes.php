        ...
        <script>
            $( document ).ready(function() {
                function Puede_Enviar_Rpt(fecha_termino_rpt){   
                    var datos = {fecha_termino_rpt : fecha_termino_rpt,
                ...
                function Obtener_Carreras_Del_Alumno(id_alumno){                                           
                    var datos = {Tipo_Movimiento : 'OBTENER_CARRERAS_x_SS',
                               id_alumno : id_alumno
                           };
                    $.ajax({
                       data : datos,
                ...
                function Obtener_Mis_Reportes_Bimestrales(id_ss){
                    var datos = {Tipo_Movimiento : 'OBTENER_MIS_REPORTES_BIMESTRALES',
                               id_ss : id_ss
                           };
                    $.ajax({
                       data : datos,
