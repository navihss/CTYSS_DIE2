    ...
    <script>
        $(document).ready(function() {
            ...
            function Obtener_Mis_Inscripciones(id_alumno, id_carrera) {
                ...
                var datos = {
                    Tipo_Movimiento: 'OBTENER_MIS_INSCRIPCIONES',
                    id_alumno: id_alumno,
                                    ...
                                    $('#ventanaConfirmacionBorrar').dialog({
                                        buttons: {
                                            "Aceptar": function() {
                                                ...
                                                $.ajax({
                                                        data: {
                                                            Tipo_Movimiento: 'BORRAR_INSCRIPCION',
                                                            id_inscripcion: id_inscripcion,
                                                            id_carrera: id_carrera,
            ...
            function Obtener_Mis_Documentos_Enviados(id_inscripcion, id_documento) {
                var datos = {
                    Tipo_Movimiento: 'OBTENER_DOCS_ENVIADOS',
                    id_inscripcion: id_inscripcion,
            ...
            function Obtener_Propuestas(id_carrera) {
                var datos = {
                    Tipo_Movimiento: 'OBTENER_PROPUESTAS_AUT_CARRERA',
                    id_carrera: id_carrera
                };
                $.ajax({
                        data: datos,
