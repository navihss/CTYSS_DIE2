        ...
        <script>
            $( document ).ready(function() {
                ...
                function Obtener_Reportes_Estadisticas(tx_alumno,id_carrera,
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_PROGRAMAS_SERVICO_SOCIAL_PP',
                        			tx_alumno 			: tx_alumno,
                       ...
                       .done(function(respuesta,textStatus,jqXHR){
                           ...
                           if (respuesta.success == true){
                               ...
                               $.each(respuesta.data.registros, function( key, value ) {
                                       ...
                                       html_table += '<TD>' + value['responsable_pss'] + '</TD>';
                                       html_table += '<TD>' + value['jefe_inmediato_ss'] + '</TD>';
              ...
              //LLENAMOS LOS CATALOGOS
                function Obtener_Catalogo_Estatus(id_carrera){
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_CATALOGO_ESTATUS', 
                    			id_carrera  : id_carrera
                            };
              ...
              //LLENAMOS LOS CATALOGOS
                function Obtener_Catalogo_Genero(id_carrera){
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_CATALOGO_GENERO', 
                    			id_carrera  : id_carrera
                            };
                ...
                function Obtener_Catalogo_Dependencia(id_carrera){
                    ...
                    var datos = {Tipo_Movimiento : 'OBTENER_CATALOGO_DEPENDENCIA', 
                    			id_carrera  : id_carrera
                            };
        ...
        <div class="barra_Herramientas_exportables">
            <div >
                <div >
                	<form action="" method="post" target="_blank" id="FormularioExportacion">
                        ...
                        <a href="javascript:enviar_formulario('word','Profesores',3,'Programas Servicio Social por Programas')" ><img src="css/images/office_word.png"/></a> |
                        <a href="javascript:enviar_formulario('excel','Profesores',3,'Programas Servicio Social por Programas')"><img src="css/images/office_excel.png"/></a> |
                        <a href="javascript:enviar_formulario('pdf','Profesores',3,'Programas Servicio Social por Programas')"><img src="css/images/Oficina_PDF.png"/></a>
            ...
            <div class="encabezado_Formulario">
                <div class="descripcion_Modulo">
                        <p>Programas Servicio Social por Programas</p>
                </div>
            </div>
        <div id="id_tabla"> 
            <div>
