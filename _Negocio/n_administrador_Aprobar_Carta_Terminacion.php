...
require_once($_SERVER["DOCUMENT_ROOT"] . '/CTYSS_DIE/_Datos/d_administrador_Aprobar_Carta_Terminacion.php');
...
switch ($tipo_Movimiento) {
    ...
    case "ACTUALIZAR_ESTATUS_CARTA_TERMINACION": //Actualizar el Estatus de la Carta de Aceptación
        ...
        echo $obj_d_Alumno_Mi_Servicio->Actualizar_Aceptacion_Doc_(
            $id_ss,
            $id_doc,
            $id_version,
            $id_estatus,
