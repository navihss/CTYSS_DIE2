...
require_once ($_SERVER["DOCUMENT_ROOT"] .'/CTYSS_DIE2/_Datos/d_administrador_Aprobar_Baja_Ceremonia.php');
...
switch ($tipo_Movimiento){
    ...
    case "ACTUALIZAR_ESTATUS_CEREMONIA": //Actualizamos el Estatus del Servicio Social
        ...
        echo $obj_d_Admon_Aprobar_Baja_Ceremonia->Actualizar_Estatus_Ceremonia($id_ceremonia, 
                $id_usuario, $id_estatus, $id_tipo_baja, $nota, $id_carrera, $id_administrador, $correo_usr, $id_division);
        break;    
}
