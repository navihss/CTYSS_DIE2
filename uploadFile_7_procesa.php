...
require_once ($_SERVER["DOCUMENT_ROOT"] .'/CTYSS_DIE2/_Datos/d_Alumno_Mi_Ceremonia.php');
    ...
    if ($_FILES["file"]["type"] == "application/pdf" && 
        ...
        if ($_FILES["file"]["error"] > 0){
            echo "Código de Error: " . $_FILES["file"]["error"] . "<br/><br/>";
              ...
              $archivo = 'Docs/Ceremonias/' . $_POST['id_usuario_doc'] . '_' . 
              ...
              {
                    //Actualizamos el estatus del documento a 2. Por Autorizar Admin
                    $obj_ = new d_Alumno_Mi_Ceremonia();
                    $array = json_decode($obj_->Actualizar_Estatus_Doc_Enviado(
                            $_POST['id_ceremonia_doc'], $_POST['id_documento_doc'], 
                            $_POST['version_doc'], 2));
